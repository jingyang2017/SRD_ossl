...
def train_ssldistill(epoch, train_loader,utrain_loader, module_list, criterion_list, optimizer, opt):
    """One epoch distillation"""
    for module in module_list:
        module.train()
...
def train_ssldistill2(epoch, train_loader,utrain_loader, module_list, criterion_list, optimizer, opt):
    ...
    return top1.avg, losses.avg    """One epoch distillation"""
    # set modules as train()
    for module in module_list:
        module.train()
